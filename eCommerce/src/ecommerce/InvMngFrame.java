 ...
 * @author zoey42
 */
public class InvMngFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewProductButton.setText("View Product Inventory");
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        InvMngFrame.this.setVisible(false); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvMngFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvMngFrame().setVisible(true);
            }
        });
    }
