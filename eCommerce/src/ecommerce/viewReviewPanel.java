...
public class viewReviewPanel extends javax.swing.JPanel {
     ...
     */
    public viewReviewPanel(JPanel bottomPanel, ReviewDirectory reviews1) {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        priceLabel.setText("Customer Name");
        ...
        headingLabel.setText("Review Details");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(commentTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(layout.createSequentialGroup()
    ...
    private void viewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewButtonActionPerformed
        ...
        if (selectedIndex < 0) {
            ...
            Review selectedProd = (Review) model.getValueAt(selectedIndex, 0);
            nameField.setText(selectedProd.getProductName());
            customerNameField.setText(String.valueOf(selectedProd.getCustomerName()));
            commentTextField.setText(selectedProd.getCustomerComment());
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedIndex < 0) {
            ...
            DefaultTableModel model = (DefaultTableModel) userTable.getModel();
            Review selectedProducts = (Review) model.getValueAt(selectedIndex, 0);
            reviews.removeReview(selectedProducts);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (selectedIndex < 0) {
            ...
            DefaultTableModel model = (DefaultTableModel) userTable.getModel();
            selectedProduct = (Review) model.getValueAt(selectedIndex, 0);
            selectedProduct.setProductName(nameField.getText());
            selectedProduct.setCustomerName(customerNameField.getText());
            selectedProduct.setCustomerComment(commentTextField.getText());

            JOptionPane.showMessageDialog(this, "Review Details Updated", "Success", HEIGHT);
        }
    ...
    public void populateTable() {
        DefaultTableModel model = (DefaultTableModel) userTable.getModel();
        model.setRowCount(0);
        for (Review u : reviews.getAllReviews()) {
            Object[] row = new Object[2];
            row[0] = u;
            row[1] = u.getCustomerName();
            model.addRow(row);
    }
            clearFields();
}
